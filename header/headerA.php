    ...
    <div class="menu_admin">
        ...
        <div class="end">
            ...
            if ($data['rôle'] == 'Administrateur') {
                echo '<div class=" my-2">
                    <a class="btn btn-primary" href="../pages/pageAdmin.php" role="button">User</a>
                    </div>
                    <div class="my-2">
                    <a class="btn btn-primary disabled" href="../pages/listeArchive.php" role="button">Archivé(é)s</a>
                    </div>';
            } else if ($data['rôle'] == 'Utilisateur') {
                echo '<div class=" my-2">
                    <a class="btn btn-primary" href="../pages/pageUser.php" role="button">User</a>
                    </div>
                    <div class="my-2">
                    <a class="btn btn-primary disabled" href="../pages/listeArchiveU.php" role="button">Archivé(é)s</a>
                </div>';
            }
            ?>
